#[cfg(test)]
mod test_bulk_rules {
    use crate::compat::bulk_rule_registry::{verify_bulk_rules, get_bulk_rule_count, get_bulk_rule_mapping};
    ...
    fn test_bulk_rule_verification() {
        ...
        assert_eq!(count, expected_count, "应有{}个规则，实际有{}", expected_count, count);
